...
GO
PRINT N'Rename refactoring operation with key 9a7ed9ac-5d16-40e4-a849-e47d59826873 is skipped, element [dbo].[User].[Id] (SqlSimpleColumn) will not be renamed to UserID';


GO
PRINT N'Rename refactoring operation with key 04855231-957e-4481-8472-d24a38c0607e is skipped, element [dbo].[User].[Last] (SqlSimpleColumn) will not be renamed to LastName';


GO
PRINT N'Rename refactoring operation with key 8716b1c7-89a4-4446-9f81-f1e7e8fb62b6 is skipped, element [dbo].[User].[Firstname] (SqlSimpleColumn) will not be renamed to FirstName';


GO
PRINT N'Rename refactoring operation with key 919680f5-1666-48ee-b548-8e41f38ce00e is skipped, element [dbo].[User].[Email] (SqlSimpleColumn) will not be renamed to Password';


GO
PRINT N'Rename refactoring operation with key 535c69bd-9170-4b0a-94d8-9aaf6ba75d06 is skipped, element [dbo].[Role].[Role] (SqlSimpleColumn) will not be renamed to RoleName';


GO
PRINT N'Rename refactoring operation with key 34a1035b-286a-4c4a-bd74-13edc15356cc is skipped, element [dbo].[UserRole].[Id] (SqlSimpleColumn) will not be renamed to UserID';


GO
PRINT N'Rename refactoring operation with key d60d7fe1-530b-40a1-9eae-649a7f78b2ec is skipped, element [dbo].[Role].[Id] (SqlSimpleColumn) will not be renamed to RoleID';


GO
PRINT N'Rename refactoring operation with key f6f49240-d91d-4708-b3db-526905fbb7e8 is skipped, element [dbo].[UserProfile].[EmployeeID] (SqlSimpleColumn) will not be renamed to DisplayID';


GO
PRINT N'Rename refactoring operation with key a54a2dcb-5959-4d2b-9991-ff3497fcb92c is skipped, element [dbo].[UserProfile].[Address1] (SqlSimpleColumn) will not be renamed to Address';


GO
PRINT N'Rename refactoring operation with key d5733967-bfd8-46c8-b618-f679437713ac is skipped, element [dbo].[EmergencyContact].[Relation] (SqlSimpleColumn) will not be renamed to Relationship';


GO
PRINT N'Rename refactoring operation with key 41485ca8-c980-4d54-9e7f-03a9c968152a, 0e3d6cbe-ee77-49af-864a-2c24b3dd9426 is skipped, element [dbo].[LeaveAssign].[Id] (SqlSimpleColumn) will not be renamed to LeaveTypeDescription';


GO
PRINT N'Rename refactoring operation with key 2cc1723f-f5c5-4dd1-bc65-7010c0856c2b is skipped, element [dbo].[UsersProfile].[WorkTitle] (SqlSimpleColumn) will not be renamed to WorkTitleID';


GO
PRINT N'Rename refactoring operation with key 1156bc50-8658-476b-a169-c2f9a2ddacc4 is skipped, element [dbo].[UsersEducation].[StartYear] (SqlSimpleColumn) will not be renamed to StartPeriod';


GO
PRINT N'Rename refactoring operation with key 1cc6a202-53e1-4a1a-8ab6-ba70f582aa41 is skipped, element [dbo].[UsersEducation].[EndYear] (SqlSimpleColumn) will not be renamed to EndPeriod';
...
GO
ALTER TABLE [dbo].[UsersDocuments] WITH NOCHECK
...
GO
ALTER TABLE [dbo].[UsersEmergencyContact] WITH NOCHECK
...
GO
ALTER TABLE [dbo].[UsersExperience] WITH NOCHECK
...
GO
ALTER TABLE [dbo].[UsersLeaveApply] WITH NOCHECK
...
GO
ALTER TABLE [dbo].[UsersProfile] WITH NOCHECK
...
GO
ALTER TABLE [dbo].[UsersReporting] WITH NOCHECK
...
GO
ALTER TABLE [dbo].[UsersRole] WITH NOCHECK
...
GO
ALTER TABLE [dbo].[UsersWork] WITH NOCHECK
...
GO
ALTER TABLE [dbo].[UsersDocuments] WITH CHECK CHECK CONSTRAINT [FK_UserEducation_ToUserDocuments];

ALTER TABLE [dbo].[UsersEducation] WITH CHECK CHECK CONSTRAINT [FK_UserEducation_ToUser];

ALTER TABLE [dbo].[UsersEmergencyContact] WITH CHECK CHECK CONSTRAINT [FK_UserEmergencyContact_ToUser];

ALTER TABLE [dbo].[UsersExperience] WITH CHECK CHECK CONSTRAINT [FK_UserExperience_ToUser];

ALTER TABLE [dbo].[UsersLeaveApply] WITH CHECK CHECK CONSTRAINT [FK_LeaveApply_ToUser];

ALTER TABLE [dbo].[UsersLeaveApply] WITH CHECK CHECK CONSTRAINT [FK_LeaveApply_ToLeaveType];

ALTER TABLE [dbo].[UsersLeaveApply] WITH CHECK CHECK CONSTRAINT [FK_LeaveApply_ApprovedBy_ToUser];

ALTER TABLE [dbo].[UsersProfile] WITH CHECK CHECK CONSTRAINT [FK_UserProfile_ToUser];

ALTER TABLE [dbo].[UsersReporting] WITH CHECK CHECK CONSTRAINT [FK_UserReporting_ToUser];

ALTER TABLE [dbo].[UsersReporting] WITH CHECK CHECK CONSTRAINT [FK_UserReporting_RepotingToUserID_ToUser];

ALTER TABLE [dbo].[UsersRole] WITH CHECK CHECK CONSTRAINT [FK_UserRole_ToUser];

ALTER TABLE [dbo].[UsersRole] WITH CHECK CHECK CONSTRAINT [FK_UserRole_ToRole];

ALTER TABLE [dbo].[UsersWork] WITH CHECK CHECK CONSTRAINT [FK_UserWork_ToUser];
